...
import br.com.cradlesoft.model.Conta;
 ...
 */
@Stateless
@Path("br.com.cradlesoft.model.conta")
public class ContaFacadeREST extends AbstractFacade<Conta> {
    ...
    public void create(Conta entity) {
        entity.setCtaDtCriacao(getDataHora());
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Conta entity) {
        entity.setCtaDtEdicao(getDataHora());
        super.edit(entity);
    }
    ...
    public Conta find(@PathParam("id") Integer id) {
